/* original version: https://github.com/processing-js/processing-js/blob/master/src/Parser/Parser.js
  changed by @abagames
  - export the parseProcessing and getGlobalMembers functions
  - parseProcseeing return ASTRoot
*/
/**
  ...
  */
  ...
  function parseProcessing(code) {
    ...
    function transformInlineClass(class_) {
      var m = /\bnew\s*([A-Za-z_$][\w$]*\s*(?:\.\s*[A-Za-z_$][\w$]*)*)\s*"B\d+"\s*"A(\d+)"/.exec(class_);
    ...
    function transformFunction(class_) {
      var m = /\b([A-Za-z_$][\w$]*)\s*"B(\d+)"\s*"A(\d+)"/.exec(class_);
...
//        "$p." + this.name + " = " + this.name + ";";
    ...
    transformStatements = function(statements, transformMethod, transformClass) {
      var nextStatement = /\b(catch|for|if|switch|while|with)\s*"B(\d+)"|\b(do|else|finally|return|throw|try|break|continue)\b|("[ADEH](\d+)")|\b(case)\s+([^:]+):|\b([A-Za-z_$][\w$]*\s*:)|(;)/g;
      var res = [];
  ...
  Processing.parseProcessing = parseProcessing;
  Processing.getGlobalMembers = getGlobalMembers;
